        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>村务项目 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/proj/list" method="get">
                                <div class="row">
                                ...
                                <div class="form-group">
                                    <select id="cunid" class="form-control"  name="cunid" >
                                        <option value="">申报村民</option>
                                        ...
                                        <option value="${ i.id}">${ i.name }</option>
                                                                    ...
                                                                    <div class="form-group">
                                    <label class="" >项目名</label>
                                    <input maxlength="255" class="form-control" type="text" name="name" placeholder="请输入项目名" >
                                </div>
                                                                                    <div class="form-group">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>#</th>
                                             ...
                                             <th>项目经费
                                                                                                                        ↓<input type="checkbox" name="orderby" value="jingfei desc">
                                        ↑<input type="checkbox" name="orderby" value="jingfei asc">
                                                                                    </th>
                                             <th>审核状态
                                                                                                                            </th>
                                             <th>开始时间
                                        ...
                                        <tbody>
                                        <c:forEach items="${ projList }" var="i" varStatus="s">
                                        <tr>
                                            <th scope="row">${s.count}</th>
                                                     <td>
                                                    <a href="${pageContext.request.contextPath}/user/detail?id=${ i.cunidFrn.id }">${ i.cunidFrn.name }</a>
                                                </td>
                                                        <td>${ i.name }</td>
                                                        <td>${ i.lixiang }</td>
                                                        <td>${ i.remark }</td>
                                                        <td>${ i.jingfei }</td>
                                                        <td>${ i.status }</td>
                                                        <td><fmt:formatDate value='${ i.kais }'  pattern='yyyy-MM-dd HH:mm:ss'/></td>
                                                        <td><fmt:formatDate value='${ i.jies }'  pattern='yyyy-MM-dd HH:mm:ss'/></td>
                                                <td>
                                            ...
                                            <c:if test="${sessionScope.user.role == 'user' &&  i.status=='通过'}">
                                                <c:if test="${i.kais==null}">
                                                    <a href="javascript:kais('${i.id}')" class="btn btn-xs btn-danger">开始</a>
                                                </c:if>
                                                <c:if test="${i.kais!=null && i.jies==null}">
                                                    <a href="javascript:jies('${i.id}')" class="btn btn-xs btn-danger">结束</a>
                                                </c:if>
                                            </c:if>
                                            </td>
                                        </tr>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                      <td style="background-color: #0FB25F">申报村民</td>
                     <td style="background-color: #0FB25F">项目名</td>
                     <td style="background-color: #0FB25F">项目立项</td>
                     <td style="background-color: #0FB25F">项目进展</td>
                     <td style="background-color: #0FB25F">项目备注</td>
                     <td style="background-color: #0FB25F">项目经费</td>
                     <td style="background-color: #0FB25F">审核状态</td>
                     <td style="background-color: #0FB25F">开始时间</td>
                     <td style="background-color: #0FB25F">结束时间</td>
                </tr>
                <tr>
                  <td>确保该申报村民在村民表中存在</td>
                 <td>项目名...</td>
                 <td>项目立项...</td>
                 <td>项目进展...</td>
                 <td>项目备注...</td>
