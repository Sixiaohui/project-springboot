                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form autocomplete="off" enctype="multipart/form-data" id="editForm" class="form-horizontal" action="${pageContext.request.contextPath}/shouru/save" method="post">
                                     <input   type="hidden" name="id"  value="${ item.id }">

<c:if test="${ not empty item.id }">
                                                                 <c:if test="${ sessionScope.user.role == 'user'}">
                                        <input readonly  type="hidden" name="cunmid" value="${ sessionScope.user.id }">
                                    </c:if>
                        <c:if test="${ sessionScope.user.role != 'user'}">
                                        <div class="form-group">
                                            <label class="col-xs-12">村民</label>
                                            <div class="col-xs-12">
                                                <select  required  class="form-control w200" name="cunmid">
                                                    <option value="">请选择村民</option>
                                                                                                        <c:forEach items="${ cunmidFrnList }" var="i" varStatus="s">
                                                        <option <c:if test="${ item.cunmid == i.id }">selected</c:if> value="${ i.id}">${ i.name }</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-xs-12">
                                                    <input required                                                         maxlength="255" class="form-control w200"
                                                         type="text"                                                        name="year" placeholder="请输入年份" value="${ item.year }">
                                                </div>
                                            </div>
                                                                      <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input                                                          maxlength="255" class="form-control w200"
                                                         type="text"                                                        name="shouru" placeholder="请输入收入" value="${ item.shouru }">
                                                </div>
                                            </div>
                                                                      <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input                                                          maxlength="255" class="form-control w200"
                                                         type="text"                                                        name="remark" placeholder="请输入备注" value="${ item.remark }">
                                                </div>
                                            </div>
            </c:if>
