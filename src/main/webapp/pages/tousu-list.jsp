        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>投诉建议 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/tousu/list" method="get">
                                <div class="row">
                                ...
                                <div class="form-group">
                                    <select id="useird" class="form-control"  name="useird" >
                                        <option value="">投诉人</option>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${ tousuList }" var="i" varStatus="s">
                                        <tr>
                                            <th scope="row">${s.count}</th>
                                                     <td>
                                                    <a href="${pageContext.request.contextPath}/user/detail?id=${ i.useirdFrn.id }">${ i.useirdFrn.name }</a>
                                                </td>
                                                        <td>${ i.jianjie }</td>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                      <td style="background-color: #0FB25F">投诉人</td>
                     <td style="background-color: #0FB25F">投诉内容</td>
                     <td style="background-color: #0FB25F">投诉时间</td>
                     <td style="background-color: #0FB25F">回复</td>
                </tr>
                <tr>
                  <td>确保该投诉人在村民表中存在</td>
                 <td>投诉内容...</td>
