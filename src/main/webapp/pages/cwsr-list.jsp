        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>财务收入 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/cwsr/list" method="get">
                                <div class="row">
                                     <input id="pageIndex" type="hidden" name="pageIndex" value="1">


                                                            <div class="form-group">
                                    <label class="" >收入标题</label>
                                    <input maxlength="255" class="form-control" type="text" name="title" placeholder="请输入收入标题" >
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${ cwsrList }" var="i" varStatus="s">
                                        <tr>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                      <td style="background-color: #0FB25F">收入标题</td>
                     <td style="background-color: #0FB25F">收入金额</td>
                     <td style="background-color: #0FB25F">收入说明</td>
                     <td style="background-color: #0FB25F">附件</td>
                     <td style="background-color: #0FB25F">收入时间</td>
                </tr>
                <tr>
                  <td>收入标题...</td>
                 <td>收入金额...</td>
