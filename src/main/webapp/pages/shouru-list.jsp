        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>经济收入 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/shouru/list" method="get">
                                <div class="row">
                                ...
                                <div class="form-group">
                                    <select id="cunmid" class="form-control"  name="cunmid" >
                                        <option value="">村民</option>
                                                                                <c:forEach items="${ cunmidFrnList }" var="i" varStatus="s">
                                    ...
                                    <input maxlength="255" class="form-control" type="text" name="year" placeholder="请输入年份" >
                                </div>
                                                                                <div class="form-group">
                                    <label class="" >收入</label>
                                    <input maxlength="255" class="form-control" type="text" name="shouruL" placeholder="从此开始" >
                                </div>
                                <div class="form-group">
                                    <label class="" >~</label>
                                    <input maxlength="255" class="form-control" type="text" name="shouruR" placeholder="至此结束" >
                                </div>
                                        ...
                                        <c:if test="${ sessionScope.user.role == 'ganbu' ||   sessionScope.user.role == 'user'  }">
                                        <div class="form-group clearfix">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>#</th>
                                             ...
                                             <th>收入
                                                                                                                        ↓<input type="checkbox" name="orderby" value="shouru desc">
                                        ↑<input type="checkbox" name="orderby" value="shouru asc">
                                                                                    </th>
                                             <th>备注
                                                                                                                            </th>
                                            <th>操作</th>
                                        ...
                                        <tbody>
                                        <c:forEach items="${ shouruList }" var="i" varStatus="s">
                                        <tr>
                                            <th scope="row">${s.count}</th>
                                                     <td>
                                                    <a href="${pageContext.request.contextPath}/user/detail?id=${ i.cunmidFrn.id }">${ i.cunmidFrn.name }</a>
                                                </td>
                                                        <td>${ i.year }</td>
                                                        <td>${ i.shouru }</td>
                                                        <td>${ i.remark }</td>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                      <td style="background-color: #0FB25F">村民</td>
                     <td style="background-color: #0FB25F">年份</td>
                     <td style="background-color: #0FB25F">收入</td>
                     <td style="background-color: #0FB25F">备注</td>
                </tr>
                <tr>
                  <td>确保该村民在村民表中存在</td>
                 <td>年份...</td>
