        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>村土地使用 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/shiyong/list" method="get">
                                <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${ shiyongList }" var="i" varStatus="s">
                                        <tr>
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                     ...
                     <td style="background-color: #0FB25F">使用土地位置</td>
                     <td style="background-color: #0FB25F">使用原因</td>
                     <td style="background-color: #0FB25F">使用类型</td>
