                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form autocomplete="off" enctype="multipart/form-data" id="editForm" class="form-horizontal" action="${pageContext.request.contextPath}/ganbu/save" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input                                                          maxlength="255" class="form-control w200"
                                                         type="text"                                                        name="zhic" placeholder="请输入职称" value="${ item.zhic }">
                                                </div>
                                            </div>
                                                                    <div class="form-group">
                                                <label class="col-xs-12">个人简介</label>
                                                <div class="col-xs-12">
                                                    <textarea  class="form-control" style="height: 120px;width: 400px"                                                            name="describtion" placeholder="请输入个人简介">${ item.describtion }</textarea>
                                                </div>
                                            </div>
            </c:if>
