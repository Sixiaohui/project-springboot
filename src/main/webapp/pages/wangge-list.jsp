        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>网格 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/wangge/list" method="get">
                                <div class="row">
                                     <input id="pageIndex" type="hidden" name="pageIndex" value="1">


                                                            <div class="form-group">
                                    <label class="" >网格名</label>
                                    <input maxlength="18" class="form-control" type="text" name="name" placeholder="请输入网格名" >
                                </div>
                                                                             <c:if test="${ sessionScope.user.role != 'ganbu'}">
                                <div class="form-group">
                                    <select id="fuzeid" class="form-control"  name="fuzeid" >
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>#</th>
                                             ...
                                             <th>土地利用率
                                                                                                                        ↓<input type="checkbox" name="orderby" value="liyong desc">
                                        ↑<input type="checkbox" name="orderby" value="liyong asc">
                                                                                    </th>
                                            <th>操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${ wanggeList }" var="i" varStatus="s">
                                        <tr>
                                            <th scope="row">${s.count}</th>
                                                    <td>${ i.name }</td>
                                                        ...
                                                        <td>${ i.quyu }</td>
                                                         <td>
                                                    <a href="${pageContext.request.contextPath}/ganbu/detail?id=${ i.fuzeidFrn.id }">${ i.fuzeidFrn.name }</a>
                                                </td>
                                                        <td>${ i.liyong }</td>
                                                <td>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                      <td style="background-color: #0FB25F">网格名</td>
                     <td style="background-color: #0FB25F">网格编号</td>
                     <td style="background-color: #0FB25F">所属区域</td>
                     <td style="background-color: #0FB25F">负责人</td>
                     <td style="background-color: #0FB25F">土地利用率</td>
                </tr>
                <tr>
                  <td>网格名...</td>
                 <td>网格编号...</td>
