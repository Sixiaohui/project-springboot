        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>村干部 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/ganbu/list" method="get">
                                <div class="row">
                                    ...
                                    <input maxlength="18" class="form-control" type="text" name="name" placeholder="请输入姓名" >
                                </div>
                                                                    <div class="form-group">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${ ganbuList }" var="i" varStatus="s">
                                        <tr>
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                     ...
                     <td style="background-color: #0FB25F">职称</td>
                     <td style="background-color: #0FB25F">个人简介</td>
                </tr>
                <tr>
                  <td>用户名...</td>
                 <td>密码...</td>
