        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>资金使用 列表</h4></div>

                            <div class="card-body">
                               <form id="dataForm" class="form-inline" action="${pageContext.request.contextPath}/zjsy/list" method="get">
                                <div class="row">
                                     <input id="pageIndex" type="hidden" name="pageIndex" value="1">


                                                            <div class="form-group">
                                    <label class="" >支出用途</label>
                                    <input maxlength="255" class="form-control" type="text" name="yongtu" placeholder="请输入支出用途" >
                                </div>
                                                                                <div class="form-group">
                                    <label class="" >支出类型</label>
                                    <input maxlength="255" class="form-control" type="text" name="type" placeholder="请输入支出类型" >
                                </div>
                                                                                            <div class="form-group">
                                                        <label class="">支出时间</label>
                                                        <input autocomplete="off" class="form-control js-datetimepicker" type="text"  name="shijianL" placeholder="从此开始"  data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD HH:mm:ss" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="">~</label>
                                                        <input autocomplete="off" class="form-control js-datetimepicker" type="text"  name="shijianR" placeholder="到此结束"  data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD HH:mm:ss" />
                                                    </div>
                                                             <c:if test="${ sessionScope.user.role != 'ganbu'}">
                                <div class="form-group">
                                    <select id="name" class="form-control"  name="name" >
                                        <option value="">负责人</option>
                                                                                <c:forEach items="${ nameFrnList }" var="i" varStatus="s">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${ zjsyList }" var="i" varStatus="s">
                                        <tr>
                                            <th scope="row">${s.count}</th>
                                                    <td>${ i.yongtu }</td>
                                                        <td>${ i.type }</td>
                                                        <td>${ i.price }</td>
                                                        <td><fmt:formatDate value='${ i.shijian }'  pattern='yyyy-MM-dd HH:mm:ss'/></td>
                                                         <td>
                                                    <a href="${pageContext.request.contextPath}/ganbu/detail?id=${ i.nameFrn.id }">${ i.nameFrn.name }</a>
                                                </td>
                                                        <td>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="modal-table">
                <tr>
                      <td style="background-color: #0FB25F">支出用途</td>
                     <td style="background-color: #0FB25F">支出类型</td>
                     <td style="background-color: #0FB25F">支出金额</td>
                     <td style="background-color: #0FB25F">支出时间</td>
                     <td style="background-color: #0FB25F">使用明细</td>
                     <td style="background-color: #0FB25F">负责人</td>
